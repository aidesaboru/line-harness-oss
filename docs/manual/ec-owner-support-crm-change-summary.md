...
- `corepack pnpm support-crm:release-readiness` でPR-safe summaryを含むPR証跡、PR本文の最新commit SHA、PR merge state、最新commitのCI run head、draft解除前の内部FAIL、外部WAIT、PASSを整理

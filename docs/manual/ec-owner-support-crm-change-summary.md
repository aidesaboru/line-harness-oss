...
- staff名が空欄の古いアカウントでは、理由を表示し、案件/マニュアル/チャット候補の読み込みと操作を止める
...
- empty staff-name mock sessionで `/support` を開き、スタッフ名警告が出ること、ダミー案件/マニュアルが表示されないこと、案件/マニュアル/チャット候補APIが呼ばれないことを確認
- コンソールエラーは0件

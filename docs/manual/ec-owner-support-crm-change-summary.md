...
- Admin update route tests confirm setup and SSE stream failures keep only fixed errors plus exception kind, without Cloudflare project names, update IDs, token-like text, or raw exception messages.

...
- Webhook/events route tests, Worker typecheck, and Worker build confirm removing identifier debug logs from webhook, LIFF, and booking routes does not change behavior.
